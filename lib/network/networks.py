...
def get_pose_net(cfg, is_train):
    ...
    elif cfg.MODEL.NAME == 'pose_mobilenet_v2':
        from lib.network import pose_mobilenetV2
        return pose_mobilenetV2.get_model(cfg, is_train)
...
if __name__ == '__main__':
    ...
    # 実行方法 python -m lib.network.networks --cfg experiments/~